...
struct MockData {
    ...
    // Ketamine form IDs
    static let ketamineIVID = UUID(uuidString: "10000000-0000-0000-0000-000000000020")!
    static let ketamineTrocheID = UUID(uuidString: "10000000-0000-0000-0000-000000000021")!
    static let ketamineSpravatoID = UUID(uuidString: "10000000-0000-0000-0000-000000000022")!
    static let ketamineIMID = UUID(uuidString: "10000000-0000-0000-0000-000000000023")!

    // MARK: - Strains
    static let strains: [Strain] = [
        Strain(id: goldenTeachersID, name: "Golden Teachers", parentSubstance: .psilocybin, species: "Psilocybe cubensis", potency: .moderate, description: "One of the most popular and well-known psilocybin varieties. Golden Teachers are beloved for their reliable, gentle introduction to psychedelic experiences. They produce warm visuals, a sense of connection, and introspective clarity without overwhelming intensity.", commonEffects: [.visualDistortions, .introspection, .euphoria], bodyFeel: [.warm, .light], emotionalProfile: [.calm, .introspective, .euphoric], onset: "30-60 min", duration: "4-6 hours", difficulty: .beginner, averageRating: 4.7, reviewCount: 89, communityPhotoCount: 34),
        Strain(id: albinoPEID, name: "Albino Penis Envy", parentSubstance: .psilocybin, species: "Psilocybe cubensis", potency: .veryStrong, description: "A potent variant of the famous Penis Envy variety with albino coloring. Known for intense visuals, deep physical sensations, and powerful ego dissolution. Not recommended for beginners—this variety demands respect and preparation.", commonEffects: [.visualDistortions, .dissolution, .bodyHigh, .spiritualExperience], bodyFeel: [.heavy, .tingly, .warm], emotionalProfile: [.profound, .euphoric], onset: "20-45 min", duration: "5-7 hours", difficulty: .experienced, averageRating: 4.8, reviewCount: 56, communityPhotoCount: 22),
        Strain(id: bPlusID, name: "B+", parentSubstance: .psilocybin, species: "Psilocybe cubensis", potency: .moderate, description: "B+ is a versatile, forgiving variety known for its warm euphoria and gentle visuals. It's a fantastic choice for beginners, offering a positive, uplifting experience with minimal body load and a clear-headed quality.", commonEffects: [.euphoria, .relaxation, .creativity], bodyFeel: [.light, .warm, .relaxed], emotionalProfile: [.calm, .euphoric, .giggly], onset: "30-60 min", duration: "4-5 hours", difficulty: .beginner, averageRating: 4.5, reviewCount: 72, communityPhotoCount: 18),
        ...
        Strain(id: blueMeanieID, name: "Blue Meanie", parentSubstance: .psilocybin, species: "Panaeolus cyanescens", potency: .strong, description: "Blue Meanies are a potent variety known for intense visual experiences and waves of euphoria. The name comes from their tendency to bruise blue. They produce a more energetic, colorful trip compared to cubensis varieties.", commonEffects: [.visualDistortions, .euphoria, .energizing], bodyFeel: [.energetic, .tingly, .light], emotionalProfile: [.euphoric, .giggly], onset: "15-30 min", duration: "4-6 hours", difficulty: .intermediate, averageRating: 4.4, reviewCount: 38, communityPhotoCount: 15),
        Strain(id: mazatecID, name: "Mazatec", parentSubstance: .psilocybin, species: "Psilocybe cubensis", potency: .moderate, description: "Named after the Mazatec people of Oaxaca, Mexico, who have used psilocybin mushrooms ceremonially for centuries. This variety is known for its spiritual depth and introspective quality, often producing profound insights and a sense of sacred connection.", commonEffects: [.spiritualExperience, .introspection, .emotionalRelease], bodyFeel: [.warm, .relaxed], emotionalProfile: [.profound, .introspective, .calm], onset: "30-60 min", duration: "4-6 hours", difficulty: .intermediate, averageRating: 4.6, reviewCount: 29, communityPhotoCount: 8),
        ...
        // Ketamine forms
        Strain(id: ketamineIVID, name: "IV Infusion", parentSubstance: .ketamine, species: "Ketamine HCl", potency: .strong, description: "Administered intravenously in a clinical setting, typically over 40 minutes. Provides precise dosing control.", commonEffects: [.dissociation, .introspection, .relaxation], bodyFeel: [.heavy, .warm, .relaxed], emotionalProfile: [.calm, .introspective, .profound], onset: "Immediate", duration: "45-60 min + afterglow", difficulty: .experienced, averageRating: 4.5, reviewCount: 68, communityPhotoCount: 2),
        Strain(id: ketamineTrocheID, name: "Sublingual Troche", parentSubstance: .ketamine, species: "Ketamine HCl", potency: .moderate, description: "Dissolves under the tongue over 15-20 minutes. Common for at-home therapeutic use under medical supervision.", commonEffects: [.relaxation, .introspection, .emotionalRelease], bodyFeel: [.warm, .relaxed], emotionalProfile: [.calm, .introspective, .loving], onset: "15-30 min", duration: "1-2 hours", difficulty: .intermediate, averageRating: 4.3, reviewCount: 45, communityPhotoCount: 1),
        Strain(id: ketamineSpravatoID, name: "Nasal Spray (Spravato)", parentSubstance: .ketamine, species: "Esketamine", potency: .moderate, description: "FDA-approved esketamine nasal spray. Administered in certified healthcare settings for treatment-resistant depression.", commonEffects: [.relaxation, .emotionalRelease, .dissociation], bodyFeel: [.light, .relaxed], emotionalProfile: [.calm, .loving, .introspective], onset: "5-15 min", duration: "1-2 hours", difficulty: .intermediate, averageRating: 4.2, reviewCount: 52, communityPhotoCount: 0),
        Strain(id: ketamineIMID, name: "Intramuscular", parentSubstance: .ketamine, species: "Ketamine HCl", potency: .strong, description: "Injected into muscle tissue in clinical settings. Faster onset than sublingual, used in therapeutic contexts.", commonEffects: [.dissociation, .visualDistortions, .introspection], bodyFeel: [.heavy, .warm, .tingly], emotionalProfile: [.profound, .introspective, .calm], onset: "5-10 min", duration: "1-1.5 hours", difficulty: .experienced, averageRating: 4.4, reviewCount: 31, communityPhotoCount: 1),
    ]
    ...
    static let tripReports: [TripReport] = {
        ...
        return [
            ...
            TripReport(id: UUID(), strainId: libertyCapsID, rating: 5, setting: .nature, intention: "Spiritual connection with the land", experienceTypes: [.visual, .spiritual], visualIntensity: 4, bodyIntensity: 3, emotionalIntensity: 4, moods: [.profound, .peaceful, .euphoric], highlights: "The experience felt ancient—like connecting with something far older than humanity. Vivid open-eye visuals of geometric patterns overlaid on the landscape. A deep sense of reverence for the natural world.", safetyNotes: "Always ensure proper identification and safe sourcing through legal channels. Have an experienced sitter present.", wouldRepeat: true, authorName: "ForestBather", date: daysAgo(20)),
    ...
    static let substances: [Substance] = [
        Substance(
            ...
            jurisdictionStatuses: [.colorado: .decriminalized, .oregon: .legal, .california: .illegal, .national: .illegal],
