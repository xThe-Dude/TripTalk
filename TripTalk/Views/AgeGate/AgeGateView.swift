            ...
            VStack(spacing: 32) {
                ...
                VStack(spacing: 16) {
                    ...
                    VStack(spacing: 4) {
                        ...
                        HStack(spacing: 4) {
                            Link("Terms of Service", destination: URL(string: "https://triptalk.guide/terms.html")!)
                                .font(.caption)
                                .foregroundStyle(Color.ttAccent)
                            Text(",")
                                .font(.caption)
                                .foregroundStyle(Color.ttSecondary.opacity(0.7))
                            Link("Privacy Policy", destination: URL(string: "https://triptalk.guide/privacy.html")!)
                                .font(.caption)
                                .foregroundStyle(Color.ttAccent)
                            Text(", and")
                                .font(.caption)
                                .foregroundStyle(Color.ttSecondary.opacity(0.7))
                            Link("Community Guidelines", destination: URL(string: "https://triptalk.guide/support.html")!)
                                .font(.caption)
                                .foregroundStyle(Color.ttAccent)
                        }
                    }
